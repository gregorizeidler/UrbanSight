...
class InsightGenerator:
    ...
    def _create_analysis_prompt(self, property_data: PropertyData, metrics: NeighborhoodMetrics, 
                               pois: List[POI]) -> str:
...
"""
    ...
    async def generate_insights(self, property_data: PropertyData, metrics: NeighborhoodMetrics, 
                               pois: List[POI]) -> PropertyInsight:
    ...
    def _create_fallback_insights(self, property_data: PropertyData, metrics: NeighborhoodMetrics, 
                                 pois: List[POI]) -> Dict:
